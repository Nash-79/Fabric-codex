...
- [ ] pgvector live with HNSW indexes; embeddings generated **locally**, model name recorded
- [ ] Hybrid RRF retrieval replaces `ILIKE`; limit raised well above 18
...
- [ ] ⌘K palette wired; facets and cursor pagination working
