...
export const themes = {
  light: {
    ...
    accentStrong: "#0E6961",
    accentDim: "#9AD2C5",
    accentSoft: "rgba(17,120,101,0.08)",
    accentText: "#0B5E50",
    onAccent: "#FFFFFF",
    green: "#107C10",
    amber: "#9D5D00",
  ...
  dark: {
    ...
    accentStrong: "#60E9D0",
    accentDim: "#0E6961",
    accentSoft: "rgba(42,172,148,0.12)",
    accentText: "#7FE0CB",
    onAccent: "#063D3B",
    green: "#54B054",
    amber: "#E3A008",
...
export const c = Object.fromEntries(Object.keys(themes.light).map((k) => [k, `var(--${k})`]));

export const sans =
  "'Segoe UI', 'Segoe UI Web (West European)', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', sans-serif";
export const mono = "'Cascadia Code', Consolas, ui-monospace, SFMono-Regular, Menlo, monospace";
