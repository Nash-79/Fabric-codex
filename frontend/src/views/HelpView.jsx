...
export default function HelpView() {
  ...
  if (!files.length) {
    return (
      <Empty>
        No help pages yet. In Claude Code run <Code>/docs-sync</Code> — the docs-author agent writes
        self-documentation into <Code>content/help/</Code>, grounded in the actual code.
      </Empty>
    );
  }
  ...
  return (
    <div
      style={
        isMobile
          ? {}
          : { display: "grid", gridTemplateColumns: "minmax(220px, 280px) 1fr", gap: 18 }
      }
    >
      {showList && (
        <div
          ...
          {files.map((f) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div style={{ fontSize: 13, fontWeight: active ? 600 : 500, color: c.text }}>
                    {f.title}
                  </div>
