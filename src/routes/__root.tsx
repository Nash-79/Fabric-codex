...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Fabric Codex" },
      ...
      { name: "twitter:title", content: "Fabric Codex" },
      {
      ...
      { name: "application-name", content: "Fabric Codex" },
      { name: "apple-mobile-web-app-title", content: "Fabric Codex" },
